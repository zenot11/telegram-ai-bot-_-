...
MENU_CARD_CAPTIONS = {
    ...
    "results": (
        "📊 Мои результаты\n\n"
        "Здесь сохранённые варианты, сравнение, экспорт и история подборов."
    ),
    "assistant": (
        "🤝 Помощник\n\n"
        "Мягкая поддержка, когда тревожно, сложно выбрать или нужен короткий план."
    ),
    "service": (
        "⚙️ Сервис\n\n"
        "Настройки, фильтры, приватность и справка."
    ),
    "about": (
        "ℹ️ О проекте\n\n"
