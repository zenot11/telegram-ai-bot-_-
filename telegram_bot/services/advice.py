    ...
    if balance["total"] == 0:
        steps.extend(
            [
                ...
                "Попробуй более широкую формулировку направления или убери фильтр конкурса.",
            ]
        )
        ...
        steps.append("Оставь запасной вариант: другой регион, похожее направление или другое финансирование.")
...
def _build_assessment(balance: dict[str, int]) -> str:
    ...
    if total == 0:
        return "В обычной выдаче нет подходящих вузов по этим фильтрам. Попробуй расширить регион, направление или конкурс."
