...
“Аиша” - Telegram-сервис для абитуриентов. Он помогает подобрать вуз по региону, баллам ЕГЭ, направлению и типу обучения, а также показывает категории поступления, избранное, историю подборов, сравнение и итог последнего подбора.
...
- `services/` - чистая логика: API-клиент, OpenAI wrapper, safety, validation, formatting, comparison, summary, history.
...
- `menu.py` - главное меню, профиль, избранное, `/summary`, `/history`, очистка истории, категории, регионы и направления.
